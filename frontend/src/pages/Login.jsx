        ...
        <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl border border-gray-700/50 p-6 sm:p-8">
          ...
          <div className="flex items-center justify-center mb-4 sm:mb-6">
            <div className="inline-flex items-center space-x-1.5 sm:space-x-2 bg-blue-500/10 border border-blue-500/30 rounded-full px-3 sm:px-4 py-1.5 sm:py-2">
              ...
              <span className="text-blue-400 text-xs sm:text-sm font-semibold uppercase tracking-wider">Admin Portal</span>
            </div>
          </div>

          <h2 className="text-xl sm:text-2xl font-bold text-white text-center mb-1 sm:mb-2">Welcome Back</h2>
          <p className="text-gray-400 text-center text-xs sm:text-sm mb-6 sm:mb-8">Enter your credentials to access dashboard</p>
